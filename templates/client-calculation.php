      ...
      foreach ($args as $post) {
        ...
        ?>
          <?php if ($display == 'all') { ?>
            ...
            <strong>Occupation: <?php  echo get_post_meta( $post->ID, '_client_website_value_key', true); ?></strong><br>
          ...
          <?php } elseif ($display == 'name') { ?>
            ...
            <input type="hidden" id="riskLevel" value="<?php  echo get_post_meta( $post->ID, '_client_risk_value_key', true); ?>">
            <input type="hidden" id="investLevel" value="<?php  echo get_post_meta( $post->ID, '_client_asset_value_key', true); ?>">
            <p><strong id="pInvest" style="visibility:hidden">We recommended you to invest $<span id="recommededInvest"></span></strong></p>
